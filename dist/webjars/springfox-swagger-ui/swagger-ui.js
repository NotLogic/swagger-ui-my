    ...
    function (e, t) {
        ...
        q(r, {
                splice: function (e, t) {
                    ...
                    arguments.length > 0 && "number" != typeof t && (n = H(arguments), n.length < 2 ? G(n, this.length - e) : n[1] = N.ToInteger(t)),
                    f.apply(this, n)
                }
            }, !ue);
        var ce = function () {
        ...
        q(r, {
                splice: function (e, t) {
                    ...
                    if (f < u) {
                            c = s;
                            for (var d = a - u; c < d;) n = l(c + u),
                            p = l(c + f),
                            F(r, n) ? r[p] = r[n] : delete r[p],
                            c += 1;
                            c = a;
                            for (var m = a - u + f; c > m;) delete r[c - 1],
                            c -= 1
                        } else if (f > u) for (c = a - u; c > s;) n = l(c + u - 1),
                    p = l(c + f - 1),
                    F(r, n) ? r[p] = r[n] : delete r[p],
                    c -= 1;
                    c = s;
        ...
        var mt = p.toFixed && ("0.000" !== 8e-5.toFixed(3) || "1" !== .9.toFixed(0) || "1.25" !== 1.255.toFixed(2) || "1000000000000000128" !== (0xde0b6b3a7640080).toFixed(0)),
            gt = {
                ...
                multiply: function (e, t) {
                    for (var n = -1, r = t; ++n < gt.size;) r += e * gt.data[n],
                    gt.data[n] = r % gt.base,
                    r = Math.floor(r / gt.base)
                },
                divide: function (e) {
                    for (var t = gt.size, n = 0; --t >= 0;) n += gt.data[t],
            ...
            yt = function (e) {
                ...
                if (r = "", n < 0 && (r = "-", n = -n), i = "0", n > 1e-21) if (a = gt.log(n * gt.pow(2, 69, 1)) - 69, o = a < 0 ? n * gt.pow(2, -a, 1) : n / gt.pow(2, a, 1), o *= 4503599627370496, a = 52 - a, a > 0) {
                    for (gt.multiply(0, o), s = t; s >= 7;) gt.multiply(1e7, 0),
                    s -= 7;
...
Handlebars.registerHelper("renderTextParam", function (e) {
    ...
    if (e.format && "password" === e.format && (n = "password"), l && (r = " id='" + l + "'"), o = o ? sanitizeHtml(o) : "", a) t = "<textarea class='body-textarea" + (e.required ? " required" : "") + "' name='" + s + "'" + r + u,
    ...
    return function e(t, n, r) {
                ...
                var _ = 0,
                    ...
                    O = new o.Parser({
                        onopentag: function (e, n) {
                            ...
                            var o, s = !1,
                                l = !! a.text;
                            i(w, e) && (o = w[e](e, n), a.attribs = n = o.attribs, void 0 !== o.text && (a.innerText = o.text), e !== o.tagName && (a.name = e = o.tagName, S[_] = o.tagName)),
                            b && (o = b(e, n), a.attribs = n = o.attribs, e !== o.tagName && (a.name = e = o.tagName, S[_] = o.tagName)),
                            t.allowedTags && t.allowedTags.indexOf(e) === -1 && (s = !0, y.indexOf(e) !== -1 && (j = !0, E = 1), A[_] = !0),
                            _++,
                            s || (d += "<" + e, (!m || i(m, e) || m["*"]) && r(n, function (t, n) {
                        ...
                        onclosetag: function (e) {
                            ...
                            var n = x.pop();
                            if (n) {
                                if (j = !1, _--, A[_]) return delete A[_],
        ...
        2: [function (e, t, n) {
            ...
            function i(e) {
                ...
                o[l++] = i >> 8 & 255,
                o[l++] = 255 & i;
                return 2 === a ? (i = u[e.charCodeAt(t)] << 2 | u[e.charCodeAt(t + 1)] >> 4, o[l++] = 255 & i) : 1 === a && (i = u[e.charCodeAt(t)] << 10 | u[e.charCodeAt(t + 1)] << 4 | u[e.charCodeAt(t + 2)] >> 2, o[l++] = i >> 8 & 255, o[l++] = 255 & i),
                o
            }
            function a(e) {
            ...
            function s(e) {
                ...
                return 1 === r ? (t = e[n - 1], i += l[t >> 2], i += l[t << 4 & 63], i += "==") : 2 === r && (t = (e[n - 2] << 8) + e[n - 1], i += l[t >> 10], i += l[t >> 4 & 63], i += l[t << 2 & 63], i += "="),
                a.push(i),
                a.join("")
            }
            n.toByteArray = i,
        ...
        5: [function (e, t, n) {
            (function (t) {
                ...
                function w(e, t, n, r, i) {
                    ...
                    if ("number" == typeof t) return t = 255 & t,
                    ...
                    for (var r = [], i = t; i < n;) {
                        ...
                        if (i + s <= n) {
                                ...
                                case 3:
                                    l = e[i + 1],
                                    u = e[i + 2],
                                    128 === (192 & l) && 128 === (192 & u) && (p = (15 & a) << 12 | (63 & l) << 6 | 63 & u, p > 2047 && (p < 55296 || p > 57343) && (o = p));
                                    break;
                                case 4:
                                    l = e[i + 1],
                                    u = e[i + 2],
                                    c = e[i + 3],
                                    128 === (192 & l) && 128 === (192 & u) && 128 === (192 & c) && (p = (15 & a) << 18 | (63 & l) << 12 | (63 & u) << 6 | 63 & c, p > 65535 && p < 1114112 && (o = p))
                                }
                            }
        ...
        7: [function (e, t, n) {
            ...
            function i(e, t) {
                ...
                var n = "<" + e.name,
                    i = r(e.attribs, t);
                return i && (n += " " + i),
                !t.xmlMode || e.children && 0 !== e.children.length ? (n += ">", e.children && (n += d(e.children, t)), f[e.name] && !t.xmlMode || (n += "</" + e.name + ">")) : n += "/>",
                n
            }
            function a(e) {
                return "<" + e.data + ">"
        ...
        13: [function (e, t, n) {
            var r = t.exports;[e("./lib/stringify"), e("./lib/traversal"), e("./lib/manipulation"), e("./lib/querying"), e("./lib/legacy"), e("./lib/helpers")].forEach(function (e) {
            ...
            var r = {
                ...
                i = n.compareDocumentPosition = function (e, t) {
                    var n, i, a, o, s, l, u = [],
                        c = [];
                    if (e === t) return 0;
                    for (n = e; n;) u.unshift(n),
                    n = n.parent;
                    for (n = t; n;) c.unshift(n),
                    n = n.parent;
                    for (l = 0; u[l] === c[l];) l++;
        ...
        28: [function (e, t, n) {
            ...
            r.prototype.emit = function (e) {
                ...
                default:
                    ...
                    n.apply(this, a)
                } else if (o(n)) for (a = Array.prototype.slice.call(arguments, 1), u = n.slice(), r = u.length, l = 0; l < r; l++) u[l].apply(this, a);
                return !0
            },
            r.prototype.addListener = function (e, t) {
                ...
                o(this._events[e]) && !this._events[e].warned && (n = s(this._maxListeners) ? r.defaultMaxListeners : this._maxListeners, n && n > 0 && this._events[e].length > n && (this._events[e].warned = !0, console.error("(node) warning: possible EventEmitter memory leak detected. %d listeners added. Use emitter.setMaxListeners() to increase limit.", this._events[e].length), "function" == typeof console.trace && console.trace())),
                this
            },
        ...
        31: [function (e, t, n) {
            ...
            r.prototype.onopentagname = function (e) {
                    if (this._lowerCaseTagNames && (e = e.toLowerCase()), this._tagname = e, !this._options.xmlMode && e in o) for (var t;
            ...
            r.prototype.onclosetag = function (e) {
                    if (this._updatePosition(1), this._lowerCaseTagNames && (e = e.toLowerCase()), !this._stack.length || e in s && !this._options.xmlMode) this._options.xmlMode || "br" !== e && "p" !== e || (this.onopentagname(e), this._closeCurrentTag());
                        ...
                        if (t !== -1) if (this._cbs.onclosetag) for (t = this._stack.length - t; t--;) this._cbs.onclosetag(this._stack.pop());
            ...
            r.prototype.oncdata = function (e) {
                    this._updatePosition(1),
                    this._options.xmlMode || this._options.recognizeCDATA ? (this._cbs.oncdatastart && this._cbs.oncdatastart(), this._cbs.ontext && this._cbs.ontext(e), this._cbs.oncdataend && this._cbs.oncdataend()) : this.oncomment("[CDATA[" + e + "]]")
                },
        ...
        34: [function (e, t, n) {
            ...
            s.prototype._stateBeforeCdata6 = function (e) {
                    "[" === e ? (this._state = z, this._sectionStart = this._index + 1) : (this._state = k, this._index--)
                },
            ...
            s.prototype._stateAfterCdata2 = function (e) {
                    ">" === e ? (this._cbs.oncdata(this._buffer.substring(this._sectionStart, this._index - 2)), this._state = f, this._sectionStart = this._index + 1) : "]" !== e && (this._state = z)
                },
            ...
            s.prototype._parseLegacyEntity = function () {
                    ...
                    for (t > 6 && (t = 6); t >= 2;) {
                            ...
                            if (c.hasOwnProperty(n)) return this._emitPartial(c[n]),
        ...
        42: [function (e, t, n) {
            ...
            function o(e) {
                ...
                if ((h === i || !h) && clearTimeout) return h = clearTimeout,
                clearTimeout(e);
                try {
                    return h(e)
                } catch (t) {
        ...
        46: [function (e, t, n) {
            (function (n) {
                ...
                function i(t, n) {
                    ...
                    this.decoder = null,
                    this.encoding = null,
                    t.encoding && (q || (q = e("string_decoder/").StringDecoder), this.decoder = new q(t.encoding), this.encoding = t.encoding)
                }
                function a(t) {
                    return z = z || e("./_stream_duplex"),
                    this instanceof a ? (this._readableState = new i(t, this), this.readable = !0, t && "function" == typeof t.read && (this._read = t.read), void I.call(this)) : new a(t)
                }
                function o(e, t, n, r, i) {
                    ...
                    p(e, t);
                        ...
                        i || (t.reading = !1),
                        u || (t.flowing && 0 === t.length && !t.sync ? (e.emit("data", n), e.read(0)) : (t.length += t.objectMode ? 1 : n.length, i ? t.buffer.unshift(n) : t.buffer.push(n), t.needReadable && h(e))),
                        d(e, t)
                    } else i || (t.reading = !1);
                    return s(t)
                }
                ...
                function l(e) {
                    return e >= N ? e = N : (e--, e |= e >>> 1, e |= e >>> 2, e |= e >>> 4, e |= e >>> 8, e |= e >>> 16, e++),
                    e
                }
                function u(e, t) {
                ...
                function h(e) {
                    ...
                    t.needReadable = !1,
                    t.emittedReadable || (P("emitReadable", t.flowing), t.emittedReadable = !0, t.sync ? T(f, e) : f(e))
                }
                function f(e) {
                    P("emit readable"),
                    e.emit("readable"),
                ...
                function _(e, t) {
                    ...
                    var n;
                    return t.objectMode ? n = t.buffer.shift() : !e || e >= t.length ? (n = t.decoder ? t.buffer.join("") : 1 === t.buffer.length ? t.buffer.head.data : t.buffer.concat(t.length), t.buffer.clear()) : n = x(e, t.buffer, t.decoder),
                    n
                }
                function x(e, t, n) {
                    var r;
                ...
                a.prototype.push = function (e, t) {
                        ...
                        return n.objectMode || "string" != typeof e || (t = t || n.defaultEncoding, t !== n.encoding && (e = M.from(e, t), t = "")),
                        o(this, n, e, t, !1)
                    },
                ...
                a.prototype.read = function (e) {
                        ...
                        null;
                        if (e = u(e, t), 0 === e && t.ended) return 0 === t.length && j(this),
                        null;
                        var r = t.needReadable;
                        P("need readable", r),
                        (0 === t.length || t.length - e < t.highWaterMark) && (r = !0, P("length less than watermark", r)),
                        t.ended || t.reading ? (r = !1, P("reading or ended", r)) : r && (P("do read"), t.reading = !0, t.sync = !0, 0 === t.length && (t.needReadable = !0), this._read(t.highWaterMark), t.sync = !1, t.reading || (e = u(n, t)));
                        var i;
                ...
                a.prototype.resume = function () {
                        ...
                        return e.flowing || (P("resume"), e.flowing = !0, v(this, e)),
                        this
                    },
        ...
        48: [function (e, t, n) {
            (function (n) {
                ...
                function o(t) {
                    ...
                    this instanceof o || this instanceof C ? (this._writableState = new a(t, this), this.writable = !0, t && ("function" == typeof t.write && (this._write = t.write), "function" == typeof t.writev && (this._writev = t.writev)), void E.call(this)) : new o(t)
                }
                function s(e, t) {
                ...
                a.prototype.getBuffer = function () {
                        for (var e = this.bufferedRequest, t = []; e;) t.push(e),
                        e = e.next;
                        return t
                    },
    ...
    return function n(e, t, r) {
            ...
            g.prototype.buildFromSpec = function (e) {
                    ...
                    if (e.externalDocs && (this.externalDocs = e.externalDocs), this.authSchemes = this.securityDefinitions, this.securityDefinitions) for (t in this.securityDefinitions) {
                            ...
                            for (var g in h) if (a.extractExtensions(g, h), "scopes" === g) {
                                ...
                                if ("object" == typeof y) {
                                    y.vendorExtensions = {};
                                    for (var v in y) a.extractExtensions(v, y),
                    ...
                    if ("string" == typeof this.url) {
                            ...
                            else if ("undefined" == typeof this.scheme) if ("undefined" != typeof window) {
                                ...
                                if (!r.isUndefined(i)) {
                                    ...
                                    r.forEach(o, function (e) {
                                            ...
                                            if (t !== e && a.log("The '" + e + "' tag conflicts with a SwaggerClient function/property name.  Use 'client." + t + "' or 'client.apis." + e + "' instead of 'client." + e + "'."), n !== e && a.log("The '" + e + "' tag conflicts with a SwaggerClient operation function/property name.  Use 'client.apis." + n + "' instead of 'client.apis." + e + "'."), r.indexOf(d, h) > -1 && (a.log("The '" + h + "' operationId conflicts with a SwaggerClient operation function/property name.  Use 'client.apis." + n + "._" + h + "' instead of 'client.apis." + n + "." + h + "'."), h = "_" + h, m.nickname = h), r.isUndefined(i)) {
                                                    ...
                                                    i.apis = {};
                                                    var o = c[e];
                                                    r.isUndefined(o) || (i.description = o.description, i.externalDocs = o.externalDocs, i.vendorExtensions = o.vendorExtensions),
        ...
        5: [function (t, n, r) {
            (function (r) {
                ...
                c.prototype.execute = function (t, n) {
                        ...
                        s.isObject(t) && s.isObject(t.body) && t.body.type && "formData" === t.body.type && n.useJQuery && (t.contentType = !1, t.processData = !1, delete t.headers["Content-Type"]),
                        t = p(t) || t,
                ...
                u.prototype.execute = function (e) {
                        ...
                        if (this.binaryRequest(c) && u.on("request", function () {
                                ...
                                if (0 === p.indexOf("multipart/form-data")) if (delete l["Content-Type"], "[object FormData]" === {}.toString.apply(e.body)) u.send(e.body);
                                else {
                                    var h, f, d;
                                    for (h in e.body) if (f = e.body[h], Array.isArray(f)) for (d in f) u.field(h, d);
                                    else u.field(h, f)
        ...
        6: [function (e, t, n) {
            ...
            function i(e) {
                ...
                void 0 !== e.domain && ("/" === t.slice(0, 1) && (t = t.slice(1)), t = "//" + e.domain + "/" + t, void 0 !== e.proto && (t = e.proto + ":" + t)),
                t
            }
            function a(e, t) {
                var n = r(t);
                ...
                else if ("/" === n.path.slice(0, 1)) a.path = n.path,
            ...
            l.prototype.resolve = function (e, t, n, r) {
                    ...
                    for (d in e.definitions) {
                            ...
                            if (j.$ref) this.resolveInline(l, e, j, S, A, j);
                                ...
                                for (y in j.properties) g = j.properties[y],
                    ...
                    function (e, t, n, r, i) {
                            ...
                            _ === R && n.finish(t, f, S, x, A, u);
                            else n.resolveItem(t, f, S, x, A, e),
                            _ += 1,
            ...
            l.prototype.finish = function (e, t, n, r, i, a, o) {
                    ...
                    for (s in n) {
                        ...
                        if (p) if (e.definitions = e.definitions || {}, "ref" === u.resolveAs) {
                                if (o !== !0) for (c in p.obj) l = this.retainRoot(c, p.obj[c], u.root),
                                p.obj[c] = l;
            ...
            l.prototype.resolveInline = function (e, t, n, r, i, a) {
                    ...
                    if (e = e || "", p) {
                            if (0 === p.indexOf("../")) {
                                ...
                                for (e = "", o = 0; o < l.length - 1; o++) o > 0 && (e += "/"),
                                e += l[o];
                                h = !0
                            }
                            if (p.indexOf("#") >= 0) if (0 === p.indexOf("/")) u = p.split("#"),
                            s = e.split("//"),
                            l = s[1].split("/"),
                            e = s[0] + "//" + l[0] + u[0],
                            a = u[1];
                                ...
                                if (u = p.split("#"), "" !== u[0]) {
                                    if (l = e.split("/"), l = l.slice(0, l.length - 1), !h) {
                                        e = "";
                                        for (var f = 0; f < l.length; f++) f > 0 && (e += "/"),
                                        e += l[f]
                                    }
                                    e += "/" + p.split("#")[0]
                                }
                            ...
                            if (0 === p.indexOf("http:") || 0 === p.indexOf("https:")) p.indexOf("#") >= 0 ? (e = p.split("#")[0], a = p.split("#")[1]) : (e = p, a = ""),
                            r.push({
                                obj: n,
                                resolveAs: "inline",
                                root: e,
                            ...
                            else if (0 === p.indexOf("#")) a = p.split("#")[1],
                            r.push({
                                obj: n,
                                resolveAs: "inline",
                                root: e,
            ...
            l.prototype.resolveTo = function (e, t, n, r) {
                    ...
                    if ("undefined" != typeof o && null !== o) {
                            if (o.indexOf("#") >= 0) {
                                ...
                                o = u[1];
                                r = u[1]
                            } else if (0 === o.indexOf("http:") || 0 === o.indexOf("https:")) l = o,
                            r = "";
                            else {
                                for (i = e.split("/"), l = "", a = 0; a < i.length - 1; a++) l += i[a] + "/";
                                l += o,
                        ...
                        if ("object" == typeof a && this.resolveAllOf(e, a, n + 1), a && "undefined" != typeof a.allOf) {
                            ...
                            if (s.isArray(o)) {
                                ...
                                for (var u = 0; u < o.length; u++) {
                                    ...
                                    else if (l[h] = s.cloneDeep(c[h]), "properties" === h) for (r in l[h]) l[h][r]["x-resolved-from"] = p
                                }
                                t[i] = l
                            }
                        }
            ...
            t.exports.schemaToHTML = function (e, t, n, o) {
                    ...
                    function l(e) {
                        var t = '<span class="propType">',
                            n = e.type || "object";
                        return e.$ref ? t += s(e, r.simpleRef(e.$ref)) : "object" === n ? t += i.isUndefined(e.properties) ? "object" : s(e) : "array" === n ? (t += "Array[", i.isArray(e.items) ? t += i.map(e.items, s).join(",") : i.isPlainObject(e.items) ? t += i.isUndefined(e.items.$ref) ? i.isUndefined(e.items.type) || i.indexOf(["array", "object"], e.items.type) !== -1 ? s(e.items) : e.items.type : s(e.items, r.simpleRef(e.items.$ref)) : (r.log("Array type's 'items' schema is not an array or an object, cannot process"), t += "object"), t += "]") : t += e.type,
                        t += "</span>"
                    }
                    function u(e, t) {
                        var n = "",
            ...
            a.prototype.securityDefinitions = function (e, t) {
                    if (e.authorizations) {
                        ...
                        for (n in e.authorizations) {
                            ...
                            if ("apiKey" === a.type) i.type = "apiKey",
                            i["in"] = a.passAs,
                            i.name = a.keyname || n,
                            r = !0;
                            else if ("basicAuth" === a.type) i.type = "basicAuth",
                            r = !0;
        ...
        10: [function (e, t, n) {
            ...
            var i = {
                ...
                u = t.exports = function (e, t, n, r, i, s, l, u, c) {
                    ...
                    e = e || {},
                    s = s || {},
                    e && e.options && (this.client = e.options.client || null, this.requestInterceptor = e.options.requestInterceptor || null, this.responseInterceptor = e.options.responseInterceptor || null, this.requestAgent = e.options.requestAgent),
                    ...
                    var h;
                    if (this.host || ("undefined" != typeof window ? this.host = window.location.host : this.host = "localhost"), this.parameterMacro = e.parameterMacro ||
                    function (e, t) {
                        return t["default"]
                    ...
                    var f, d;
                    if (l) for (h in l) d = new o(h, l[h], this.models, e.modelPropertyMacro),
                    d && (this.models[h] = d);
                    else l = {};
                    for (f = 0; f < this.parameters.length; f++) {
                        ...
                        "array" === g.type && (y = [y], "undefined" == typeof g.allowableValues && (delete g.isList, delete g.allowMultiple)),
                        g.modelSignature = {
                            type: y,
                    ...
                    if (S && S.schema) {
                        ...
                        delete j[A],
                        D ? (this.successResponse = {}, I = this.successResponse[A] = D) : S.schema.type && "object" !== S.schema.type && "array" !== S.schema.type ? (this.successResponse = {}, I = this.successResponse[A] = S.schema) : (this.successResponse = {}, I = this.successResponse[A] = new o((void 0), S.schema || {}, this.models, e.modelPropertyMacro)),
                        I && (I.vendorExtensions = S.vendorExtensions, S.description && (I.description = S.description), S.examples && (I.examples = S.examples), S.headers && (I.headers = S.headers)),
                        this.type = S
                    }
                    ...
                    for (var n = {}, r = this.path.replace(/#.*/, ""), i = "", a = 0; a < this.parameters.length; a++) {
                        ...
                        if ("undefined" != typeof e[o.name]) {
                            ...
                            if ("string" === o.type && "password" === o.format && t && (s = !0), "path" === o["in"]) {
                                ...
                                r = r.replace(l, u)
                            } else if ("query" === o["in"] && "undefined" != typeof e[o.name]) if (i += "" === i && r.indexOf("?") < 0 ? "?" : "&", "undefined" != typeof o.collectionFormat) {
                                var c = e[o.name];
            ...
            u.prototype.getBody = function (e, t, n) {
                    for (var r, i, a, o, s, l = {}, u = !1, p = 0; p < this.parameters.length; p++) if (i = this.parameters[p], "undefined" != typeof t[i.name]) {
                        var h;
                    ...
                    if (e["Content-Type"] && e["Content-Type"].indexOf("multipart/form-data") >= 0 && (d = !0), r && !d) {
                        ...
                        for (o in l) {
                            ...
                            "undefined" != typeof s && (Array.isArray(s) ? ("" !== m && (m += "&"), m += this.encodeQueryCollection(i.collectionFormat, o, s, g)) : ("" !== m && (m += "&"), m += encodeURIComponent(o) + "=" + c(encodeURIComponent(s), g)))
                        }
                        a = m
                    } else if (d) {
                        var y;
                        if ("function" == typeof FormData) {
                            y = new FormData,
                            y.type = "formData";
                            for (o in l) if (i = l[o].param, s = t[o], "undefined" != typeof s) if ("[object File]" === {}.toString.apply(s)) y.append(o, s);
                            else if ("file" === s.type && s.value) y.append(o, s.value);
                            else if (Array.isArray(s)) if ("multi" === i.collectionFormat) {
                                y["delete"](o);
                                for (var v in s) y.append(o, s[v])
                            } else y.append(o, this.encodeQueryCollection(i.collectionFormat, o, s).split("=").slice(1).join("="));
                            else y.append(o, s);
                            a = y
                        } else {
                            y = {};
            ...
            u.prototype.execute = function (e, t, n, r, o) {
                    ...
                    this.parent.usePromise ? p = l.defer() : (u = u || this.parent.defaultSuccessCallback || a.log, c = c || this.parent.defaultErrorCallback || a.log),
                    ...
                    if (m.length > 0) {
                            ...
                            return a.fail(g),
                            this.parent.usePromise ? (p.reject(g), p.promise) : (c(g, o), {})
                        }
            ...
            u.prototype.setContentTypes = function (e, t) {
                    ...
                    if ("post" === this.method || "put" === this.method || "patch" === this.method || ("delete" === this.method || "get" === this.method) && m) {
                            if (t.requestContentType && (s = t.requestContentType), c.length > 0) {
                                ...
                                else if (this.consumes && this.consumes.length > 0) for (var g in this.consumes) {
                                ...
                                if (p) {
                                    ...
                                    for (var d = 0; d < this.parameters.length; d++) {
                                        ...
                                        if ("formData" === m["in"]) {
                                            f || (f = "");
                                            var g;
                                            if (g = "function" == typeof FormData && a.body instanceof FormData ? a.body.getAll(m.name) : a.body[m.name]) if ("file" === m.type) g.name && (f += "-F " + m.name + '=@"' + g.name + '" ');
                                            else if (Array.isArray(g)) if ("multi" === m.collectionFormat) for (var y in g) f += "-F " + this.encodeQueryKey(m.name) + "=" + c(g[y], m.format) + " ";
            ...
            u.prototype.encodeQueryCollection = function (e, t, n, r) {
                    ...
                    a += this.encodeQueryKey(t) + "=" + c(this.encodeQueryParam(n[i]), r);
                        ...
                        else if ("brackets" === e) for (i = 0; i < n.length; i++) 0 !== i && (a += "&"),
                        a += this.encodeQueryKey(t) + "[]=" + c(this.encodeQueryParam(n[i]), r);
        ...
        14: [function (e, t, n) {
            ...
            function f(e, t) {
                var n, r = 0;
                "Buffer" === t.type && Q(t.data) && (n = t.data, r = 0 | m(n.length)),
                e = d(e, r);
            ...
            i.prototype.writeUInt32LE = function (e, t, n) {
                    ...
                    i.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = e) : R(this, e, t, !0),
                    t + 4
                },
            i.prototype.writeUInt32BE = function (e, t, n) {
                    ...
                    t = 0 | t,
                    n || L(this, e, t, 4, 4294967295, 0),
                    i.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = e) : R(this, e, t, !1),
                    t + 4
                },
            ...
            i.prototype.writeInt32LE = function (e, t, n) {
                    ...
                    i.TYPED_ARRAY_SUPPORT ? (this[t] = e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : R(this, e, t, !0),
                    t + 4
                },
        ...
        15: [function (e, t, n) {
            ...
            function (e) {
                ...
                function n(e) {
                    ...
                    n((65280 & s) >> 8),
                    n(255 & s);
                    return 2 === l ? (s = t(e.charAt(r)) << 2 | t(e.charAt(r + 1)) >> 4, n(255 & s)) : 1 === l && (s = t(e.charAt(r)) << 10 | t(e.charAt(r + 1)) << 4 | t(e.charAt(r + 2)) >> 2, n(s >> 8 & 255), n(255 & s)),
                    u
                }
                function i(e) {
                    function t(e) {
            ...
            function () {
                ...
                function r() {
                    ...
                    return this instanceof r ? (e = Object.create(null), this.setCookie = function (r, a, o) {
                        ...
                        var n, r, i = [];
                        for (n in e) r = this.getCookie(n, t),
                        r && i.push(r);
        ...
        21: [function (e, t, n) {
            ...
            function o(e, t) {
                var n, r, i, a;
                if (t) for (a = Object.keys(t), n = 0, r = a.length; n < r; n += 1) i = a[n],
                e[i] = t[i];
                return e
            }
            function s(e, t) {
        ...
        22: [function (e, t, n) {
            ...
            function r(e, t) {
                var n, r, i, a, o, s, l;
                if (null === t) return {};
                for (n = {}, r = Object.keys(t), i = 0, a = r.length; i < a; i += 1) o = r[i],
                s = String(t[o]),
            ...
            function f(e, t, n, r, i) {
                ...
                if (t) for (a = 0; a < e.length; a++) {
                        ...
                        for (a = 0; a < e.length; a++) {
                            if (o = e.charCodeAt(a), o === P) s = !0,
                            f && (l = l || a - d - 1 > r && " " !== e[d + 1], d = a);
            ...
            function b(e) {
                for (var t, n, r = "", a = 0; a < e.length; a++) t = e.charCodeAt(a),
                n = ie[t],
                r += !n && c(t) ? e[a] : n || i(t);
                return r
            }
            ...
            function x(e, t, n) {
                var r, i, a, o, s, l = "",
                    u = e.tag,
                    c = Object.keys(n);
                for (r = 0, i = c.length; r < i; r += 1) s = "",
                0 !== r && (s += ", "),
                a = c[r],
                o = n[a],
                j(e, t, a, !1, !1) && (e.dump.length > 1024 && (s += "? "), s += e.dump + ": ", j(e, t, o, !1, !1) && (s += e.dump, l += s));
                e.tag = u,
                e.dump = "{" + l + "}"
            }
            function A(e, t, n, r) {
                ...
                for (i = 0, a = f.length; i < a; i += 1) c = "",
                r && 0 === i || (c += s(e, t)),
                o = f[i],
                l = n[o],
                j(e, t + 1, o, !0, !0, !0) && (u = null !== e.tag && "?" !== e.tag || e.dump && e.dump.length > 1024, u && (c += e.dump && P === e.dump.charCodeAt(0) ? "?" : "? "), c += e.dump, u && (c += s(e, t)), j(e, t + 1, l, !0, u) && (c += e.dump && P === e.dump.charCodeAt(0) ? ":" : ": ", c += e.dump, p += c));
                e.tag = h,
                e.dump = p || "{}"
            }
            function S(e, t, n) {
                var r, i, a, o, s, l;
                for (i = n ? e.explicitTypes : e.implicitTypes, a = 0, o = i.length; a < o; a += 1) if (s = i[a], (s.instanceOf || s.predicate) && (!s.instanceOf || "object" == typeof t && t instanceof s.instanceOf) && (!s.predicate || s.predicate(t))) {
            ...
            function O(e, t, n) {
                var r, i, a;
                if (null !== e && "object" == typeof e) if (i = t.indexOf(e), i !== -1) n.indexOf(i) === -1 && n.push(i);
        ...
        24: [function (e, t, n) {
            ...
            function y(e, t, n, r) {
                var i, a, o, s;
                for (z.isObject(n) || d(e, "cannot merge mappings; the provided source object is unacceptable"), i = Object.keys(n), o = 0, s = i.length; o < s; o += 1) a = i[o],
                H.call(t, a) || (t[a] = n[a], r[a] = !0)
            }
            function v(e, t, n, r, i, a) {
                var o, s;
                if (i = String(i), null === t && (t = {}), "tag:yaml.org,2002:merge" === r) if (Array.isArray(a)) for (o = 0, s = a.length; o < s; o += 1) y(e, t, a[o], n);
                else y(e, t, a, n);
                else e.json || H.call(n, i) || !H.call(t, i) || d(e, "duplicated mapping key"),
                t[i] = a,
                delete n[i];
                return t
            }
            ...
            function _(e) {
                ...
                !(45 !== t && 46 !== t || t !== e.input.charCodeAt(n + 1) || t !== e.input.charCodeAt(n + 2) || (n += 3, t = e.input.charCodeAt(n), 0 !== t && !a(t)))
            }
            function x(e, t) {
            ...
            function A(e, t, n) {
                ...
                return g(e, u, c, !1),
                !! e.result || (e.kind = y, e.result = v, !1)
            }
            function S(e, t) {
                var n, i, a;
            ...
            function j(e, t) {
                ...
                for (e.kind = "scalar", e.result = "", e.position++, n = i = e.position; 0 !== (c = e.input.charCodeAt(e.position));) {
                    if (34 === c) return g(e, n, e.position, !0),
                    e.position++,
                    !0;
                    if (92 === c) {
                        if (g(e, n, e.position, !0), c = e.input.charCodeAt(++e.position), r(c)) w(e, !1, t);
                        else if (c < 256 && ie[c]) e.result += ae[c],
                        e.position++;
                        else if ((u = l(c)) > 0) {
                            for (a = u, o = 0; a > 0; a--) c = e.input.charCodeAt(++e.position),
            ...
            function E(e, t) {
                var n, r, i, o, s, l, u, c, p, h, f, m = !0,
                    ...
                    y = e.anchor,
                    b = {};
                if (f = e.input.charCodeAt(e.position), 91 === f) o = 93,
                u = !1,
                r = [];
                else {
                        if (123 !== f) return !1;
                ...
                for (null !== e.anchor && (e.anchorMap[e.anchor] = r), f = e.input.charCodeAt(++e.position); 0 !== f;) {
                        ...
                        p = c = h = null,
                        s = l = !1,
                        63 === f && (i = e.input.charCodeAt(e.position + 1), a(i) && (s = l = !0, e.position++, w(e, !0, t))),
                        n = e.line,
                        L(e, t, Y, !1, !0),
                        p = e.tag,
                        c = e.result,
                        ...
                        !l && e.line !== n || 58 !== f || (s = !0, f = e.input.charCodeAt(++e.position), w(e, !0, t), L(e, t, Y, !1, !0), h = e.result),
            ...
            function O(e, t) {
                ...
                for (e.kind = "scalar", e.result = ""; 0 !== s;) if (s = e.input.charCodeAt(++e.position), 43 === s || 45 === s) G === l ? l = 43 === s ? X : K : d(e, "repeat of a chomping mode identifier");
                else {
                        if (!((o = u(s)) >= 0)) break;
                ...
                for (; 0 !== s;) {
                        ...
                        (!p || e.lineIndent < h) && 32 === s;) e.lineIndent++,
            ...
            function k(e, t) {
                var n, r, i, o = e.tag,
                    ...
                    l = [],
                    u = !1;
                for (null !== e.anchor && (e.anchorMap[e.anchor] = l), i = e.input.charCodeAt(e.position); 0 !== i && 45 === i && (r = e.input.charCodeAt(e.position + 1), a(r));) if (u = !0, e.position++, w(e, !0, -1) && e.lineIndent <= t) l.push(null),
            ...
            function T(e, t, n) {
                ...
                for (null !== e.anchor && (e.anchorMap[e.anchor] = p), l = e.input.charCodeAt(e.position); 0 !== l;) {
                        if (r = e.input.charCodeAt(e.position + 1), s = e.line, 63 !== l && 58 !== l || !a(r)) {
                            ...
                            if (e.line === s) {
                                ...
                                if (58 === l) l = e.input.charCodeAt(++e.position),
                        ...
                        } else 63 === l ? (y && (v(e, p, h, f, m, null), f = m = g = null), b = !0, y = !0, o = !0) : y ? (y = !1, o = !0) : d(e, "incomplete explicit mapping pair; a key node is missed"),
                        e.position += 1,
                        l = r;
                ...
                b && (e.tag = u, e.anchor = c, e.kind = "mapping", e.result = p),
                b
            }
            function C(e) {
                var t, n, r, i, o = !1,
                ...
                if (null !== e.tag && d(e, "duplication of a tag property"), i = e.input.charCodeAt(++e.position), 60 === i ? (o = !0, i = e.input.charCodeAt(++e.position)) : 33 === i ? (s = !0, n = "!!", i = e.input.charCodeAt(++e.position)) : n = "!", t = e.position, o) {
                        ...
                        for (; 0 !== i && !a(i);) 33 === i && (s ? d(e, "tag suffix cannot contain exclamation marks") : (n = e.input.slice(t - 1, e.position + 1), ne.test(n) || d(e, "named tag handle cannot contain such characters"), s = !0, t = e.position + 1)),
                        i = e.input.charCodeAt(++e.position);
            ...
            function L(e, t, n, r, i) {
                var a, o, s, l, u, c, p, h, f = 1,
                    m = !1,
                    g = !1;
                if (null !== e.listener && e.listener("open", e), e.tag = null, e.anchor = null, e.kind = null, e.result = null, a = o = s = Q === n || W === n, r && w(e, !0, -1) && (m = !0, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)), 1 === f) for (; C(e) || I(e);) w(e, !0, -1) ? (m = !0, s = a, e.lineIndent > t ? f = 1 : e.lineIndent === t ? f = 0 : e.lineIndent < t && (f = -1)) : s = !1;
                if (s && (s = m || i), 1 !== f && Q !== n || (p = Y === n || J === n ? t : t + 1, h = e.position - e.lineStart, 1 === f ? s && (k(e, h) || T(e, h, p)) || E(e, p) ? g = !0 : (o && O(e, p) || S(e, p) || j(e, p) ? g = !0 : D(e) ? (g = !0, null === e.tag && null === e.anchor || d(e, "alias node should not have any properties")) : A(e, p, Y === n) && (g = !0, null === e.tag && (e.tag = "?")), null !== e.anchor && (e.anchorMap[e.anchor] = e.result)) : 0 === f && (g = s && k(e, h))), null !== e.tag && "!" !== e.tag) if ("?" === e.tag) {
                        for (l = 0, u = e.implicitTypes.length; l < u; l += 1) if (c = e.implicitTypes[l], c.resolve(e.result)) {
            ...
            function M(e) {
                ...
                return w(e, !0, -1),
                0 === e.lineIndent && 45 === e.input.charCodeAt(e.position) && 45 === e.input.charCodeAt(e.position + 1) && 45 === e.input.charCodeAt(e.position + 2) ? (e.position += 3, w(e, !0, -1)) : u && d(e, "directives end mark is expected"),
                ...
                e.position === e.lineStart && _(e) ? void(46 === e.input.charCodeAt(e.position) && (e.position += 3, w(e, !0, -1))) : void(e.position < e.length - 1 && d(e, "end of the stream or a document separator is expected"))
            }
            function R(e, t) {
                e = String(e),
                t = t || {},
        ...
        25: [function (e, t, n) {
            ...
            r.prototype.getSnippet = function (e, t) {
                ...
                for (e = e || 4, t = t || 75, n = "", r = this.position; r > 0 && "\0\r\n\u2028\u2029".indexOf(this.buffer.charAt(r - 1)) === -1;) if (r -= 1, this.position - r > t / 2 - 1) {
                    n = " ... ",
                    r += 5;
                    break
                }
        ...
        32: [function (e, t, n) {
            ...
            function i(e, t) {
                ...
                }), this.tag = e, this.kind = t.kind || null, this.resolve = t.resolve ||
                function () {
                    return !0
        ...
        33: [function (e, t, n) {
            ...
            function i(e) {
                var t, n, r = e.replace(/[\r\n=]/g, ""),
                    ...
                    o = 0,
                    l = [];
                for (t = 0; t < i; t++) t % 4 === 0 && t && (l.push(o >> 16 & 255), l.push(o >> 8 & 255), l.push(255 & o)),
                o = o << 6 | a.indexOf(r.charAt(t));
                return n = i % 4 * 6,
                0 === n ? (l.push(o >> 16 & 255), l.push(o >> 8 & 255), l.push(255 & o)) : 18 === n ? (l.push(o >> 10 & 255), l.push(o >> 2 & 255)) : 12 === n && l.push(o >> 4 & 255),
                s ? new s(l) : l
            }
            function a(e) {
                var t, n, r = "",
                    ...
                    a = e.length,
                    o = p;
                for (t = 0; t < a; t++) t % 3 === 0 && t && (r += o[i >> 18 & 63], r += o[i >> 12 & 63], r += o[i >> 6 & 63], r += o[63 & i]),
                i = (i << 8) + e[t];
                return n = a % 3,
        ...
        44: [function (e, t, n) {
            ...
            function i(e) {
                if (null === e) return [];
                var t, n, r, i, a, o = e;
                for (a = new Array(o.length), t = 0, n = o.length; t < n; t += 1) r = o[t],
                i = Object.keys(r),
                a[t] = [i[0], r[i[0]]];
                return a
            }
        ...
        158: [function (e, t, n) {
            ...
            function s(e) {
                var t, n, r, i, a = e.split(/\r?\n/),
                    o = {};
                a.pop();
                for (var s = 0, l = a.length; s < l; ++s) n = a[s],
                t = n.indexOf(":"),
...
SwaggerUi.Views.AuthsCollectionView = Backbone.View.extend({
    ...
    renderOneAuth: function (e) {
        ...
        r && (n = new SwaggerUi.Views[r]({
            model: e,
            router: this.router
        }), t = n.render().el, this.authViews.push(n)),
    ...
    handleOauth2Login: function (e) {
        ...
        if ("oauth2" !== e.get("type") || !h || "implicit" !== h && "accessCode" !== h) {
                ...
                if (e.get("grantTypes")) {
                    ...
                    for (var d in f) f.hasOwnProperty(d) && "implicit" === d ? (r = f[d], i = r.loginEndpoint.url, u = r.loginEndpoint.url + "?response_type=token", p.tokenName = t(r)) : f.hasOwnProperty(d) && "accessCode" === d && (r = f[d], i = r.tokenRequestEndpoint.url, u = r.tokenRequestEndpoint.url + "?response_type=code", p.tokenName = t(r))
                }
            } else r = e.attributes,
...
SwaggerUi.Views.OperationView = Backbone.View.extend({
    ...
    initialize: function (e) {
        ...
        e.swaggerOptions && (this.model.defaultRendering = e.swaggerOptions.defaultModelRendering, e.swaggerOptions.showRequestHeaders && (this.model.showRequestHeaders = !0), e.swaggerOptions.showOperationIds && (this.model.showOperationIds = !0)),
        this
    },
    ...
    render: function () {
        ...
        if (a = jQuery.inArray(this.model.method, this.model.supportedSubmitMethods()) >= 0, a || (this.model.isReadOnly = !0), this.model.description = this.model.description || this.model.notes, this.model.oauth = null, m = this.model.authorizations || this.model.security) if (Array.isArray(m)) for (l = 0, u = m.length; l < u; l++) {
            n = m[l];
        ...
        } else for (o in m) if (P = m[o], "oauth2" === o) for (null === this.model.oauth && (this.model.oauth = {}), void 0 === this.model.oauth.scopes && (this.model.oauth.scopes = []), d = 0, c = P.length; d < c; d++) y = P[d],
        this.model.oauth.scopes.push(y);
        ...
        if ("undefined" == typeof this.model.responseMessages && (this.model.responseMessages = []), L = null, B = this.model.produces, z = this.contains(B, "xml"), N = !z || this.contains(B, "json"), this.model.successResponse) {
            R = this.model.successResponse;
            for (s in R) q = R[s],
            this.model.successCode = s,
            "object" == typeof q && "function" == typeof q.createJSONSample ? (this.model.successDescription = q.description, this.model.headers = this.parseResponseHeaders(q.headers), L = {
        ...
        for ($(this.el).html(Handlebars.templates.operation(this.model)), L ? (L.defaultRendering = this.model.defaultRendering, T = new SwaggerUi.Views.SignatureView({
            ...
            isParam: !1
        }, i.consumes = this.model.consumes, i.produces = this.model.produces, j = this.model.parameters, g = 0, p = j.length; g < p; g++) b = j[g],
        U = b.type || b.dataType || "",
        "undefined" == typeof U && (C = b.schema, C && C.$ref && (x = C.$ref, U = 0 === x.indexOf("#/definitions/") ? x.substring("#/definitions/".length) : x)),
        U && "file" === U.toLowerCase() && (i.consumes || (i.consumes = "multipart/form-data")),
        b.type = U;
        for (k = new SwaggerUi.Views.ResponseContentTypeView({
            model: i,
            router: this.router
        }), $(".response-content-type", $(this.el)).append(k.render().el), E = this.model.parameters, v = 0, h = E.length; v < h; v++) b = E[v],
    ...
    submitOperation: function (e) {
        ...
        if (null !== e && e.preventDefault(), n = $(".sandbox", $(this.el)), t = !0, n.find("input.required").each(function () {
            ...
            $(this).removeClass("error"),
            this.selectedIndex === -1 && ($(this).addClass("error"), $(this).wiggle({
                callback: function (e) {
                    return function () {
                        $(e).focus()
                    }
    ...
    isFileUpload: function (e) {
        var t, n, r, i, a = !1;
        for (t = e.find("input"), n = 0, r = t.length; n < r; n++) i = t[n],
        "file" === i.type && (a = !0);
        return a
    },
